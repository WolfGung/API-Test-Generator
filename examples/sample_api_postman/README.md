# Tests generated from bookshelf.postman_collection.json

Bookshelf 1.0.0: 10 operations, 14 tests in 4 modules.
...
API_BASE_URL=... API_TOKEN=... pytest sample_api_postman
```
